...
import com.capstone.progettofinale.auth.UnauthorizedException;
...
public class ExceptionsHandler {
	...
	public ErrorsPayloadWithList handleValidationErrors(MethodArgumentNotValidException e) {
		...
		return new ErrorsPayloadWithList("Ci sono errori nel payload", new Date(), new Random().nextInt(10000, 30000),
				errors);
	}
